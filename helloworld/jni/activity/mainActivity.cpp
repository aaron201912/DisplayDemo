...
static S_VideoViewCallback SVideoViewCallbackTab[] = {
    ID_MAIN_Videoview1, true, 5, NULL,
};
...
void mainActivity::onCreate() {
    ...
    mVideoview1Ptr = (ZKVideoView*)findControlByID(ID_MAIN_Videoview1);if(mVideoview1Ptr!= NULL){mVideoview1Ptr->setVideoPlayerMessageListener(this);}
	mActivityPtr = this;
	onUI_init();
